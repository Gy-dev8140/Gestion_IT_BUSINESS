...
export default function FormDevApp({ onNavigate }: { onNavigate: (view: string) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      sendWhatsAppConfirmation(client.whatsapp || client.telephone, ticketId, "DÉVELOPPEMENT APPLICATION");
      setSuccess(true);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
          ...
          <section className="space-y-4 md:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input label="Délai de réalisation" name="delai" required className="col-span-2" />
              <Textarea label="Fonctionnalités principales" name="fonctionnalites" required className="col-span-2" />
            </div>
          </section>
        </div>
      </main>
